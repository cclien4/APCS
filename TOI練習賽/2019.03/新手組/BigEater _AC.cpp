    ...
    if((N>=32 && K==0) || (N>=55 && K==1) ){
      while((N_cnt>=32 && K==0) || (N_cnt>=55 && K==1)){
             if(K==0){
                ...
                cout<<M_cnt<<": Wayne eats an Apple pie, and now he has "<<N_cnt<<" dollar."<<endl;
                else
                ...
                cout<<M_cnt<<": Wayne drinks a Corn soup, and now he has "<<N_cnt<<" dollar."<<endl;
                else
